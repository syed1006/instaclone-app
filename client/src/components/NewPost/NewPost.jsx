    ...
    return (
        <>
            <form action="" id='newpost'>
                <input className='form-input' type="text" readOnly value={'No file Chosen'}  name='message' />
            ...
            {formData.image && <img style={{width:'100px'}} src={URL.createObjectURL(formData.image)} alt="" />}
